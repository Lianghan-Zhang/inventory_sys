...
const columns: ColumnDef<InventoryItem>[] = [
  ...
  },
  {
    ...
    header: () => <div className="w-full text-right">库存数量</div>,
    cell: ({ row }) => {
  ...
  },
  {
    ...
    header: () => <div className="w-full text-right">预警阈值</div>,
    cell: ({ row }) => (
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <div className="flex items-center gap-2">
                  ...
                  return (
                    ...
                    >
                      {column.id === "name" ? "货品名称" :
                       ...
                       column.id === "quantity" ? "库存数量" :
                       column.id === "threshold" ? "预警阈值" :
                       column.id === "location" ? "库位" :
                       column.id === "lastUpdated" ? "更新时间" : column.id}
                    </DropdownMenuCheckboxItem>
                  )
                })}
            </DropdownMenuContent>
          ...
          <Button variant="outline" size="sm">
            <IconPlus />
            <span className="hidden lg:inline">添加货品</span>
          </Button>
        </div>
      </div>
      <TabsContent
